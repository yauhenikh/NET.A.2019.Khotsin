...
{
    // Implement the algorithm for bubble sorting of a integer
    // jagged array. Sort rows of the matrix in order of increasing
    // (decreasing) the sum of the elements of the rows; in ascending
    // (descending) order of the maximum elements of the rows;
    // in ascending (descending) order of the minimum elements of the rows;
    public static class JaggedArraySort
    {
        ...
        #region Helper Bubble Sort Method

        /// <summary>
        /// Orders rows of the jagged array using comparer in ascending or descending order
        /// </summary>
        /// <param name="jaggedArray">Given jagged array</param>
